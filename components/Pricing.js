              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black-500 flex-grow">
                  <li className="relative check custom-list my-2">
                    <strong>Unlimited tanpa FUP</strong>
                  </li>
                  <li className="relative check custom-list my-2">
                    Cocok untuk penggunaan hingga 10 Perangkat
                  </li>
                  <li className="relative check custom-list my-2">
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black-500 flex-grow">
                  ...
                  <li className="relative check custom-list my-2">
                    Cocok untuk penggunaan hingga 15 Perangkat
                  </li>
                  <li className="relative check custom-list my-2">
                    Harga sudah termasuk PPN
                  </li>
            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black-500 flex-grow">
                  ...
                  <li className="relative check custom-list my-2">
                    Cocok untuk penggunaan hingga 30 Perangkat
                  </li>
                  <li className="relative check custom-list my-2">
                    Harga sudah termasuk PPN
                  </li>
        ...
        <div className="flex flex-col w-full my-16" id="testimoni">
          <ScrollAnimationWrapper>
            <motion.h3
              ...
              Dipercaya oleh lebih dari 10 Juta Pengguna Aktif di Seluruh Indonesia{" "}
            </motion.h3>
            <motion.p
              variants={scrollAnimation}
              className="leading-normal mx-auto mb-2 mt-4 w-10/12 sm:w-7/12 lg:w-6/12"
            >
              Berikut adalah cerita pengguna aktif tentang layanan Internet MyRepublic.
            </motion.p>
          </ScrollAnimationWrapper>
              ...
              <div className="absolute rounded-xl  py-8 sm:py-14 px-6 sm:px-12 lg:px-16 w-full flex flex-col sm:flex-row justify-between items-center z-10 bg-white-500">
                <div className="flex flex-col text-left w-10/12 sm:w-7/12 lg:w-5/12 mb-6 sm:mb-0">
                  <h5 className="text-black-600 text-xl sm:text-2xl lg:text-3xl leading-relaxed font-medium">
                    Konsultasikan kebutuhan Internet Anda sekarang
                  </h5>
